    ...
    <div class="container-fluid container-xxl">
        ...
        <div class="offcanvas offcanvas-end text-bg-light" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
            <div class="offcanvas-header">
                ...
                <button type="button" class="ms-auto btn-close btn-close-dark" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body font-opensans">
                <ul class="navbar-nav justify-content-center flex-grow-1">
                    <li class="nav-item mx-lg-3 my-1 my-lg-0">
                        <a class="nav-link" aria-current="page" href="/home/tentang">Tentang</a>
                    </li>
                    <li class="nav-item mx-lg-3 my-1 my-lg-0">
                        <a class="nav-link" aria-current="page" href="/home/struktur">Struktur</a>
                    </li>
                    <li class="nav-item mx-lg-3 my-1 my-lg-0">
                        <a class="nav-link" aria-current="page" href="/home/kodeEtik">Kode Etik</a>
                    </li>
                    <li class="nav-item mx-lg-3 my-1 my-lg-0">
                        <a class="nav-link" aria-current="page" href="/home/anggota">Anggota</a>
                    </li>
                    <li class="nav-item mx-lg-3 my-1 my-lg-0">
                        <a class="nav-link" aria-current="page" href="/home/publikasi">Publikasi</a>
                    </li>
                    <li class="nav-item mx-lg-3 my-1 my-lg-0">
                        <a class="nav-link" aria-current="page" href="/home/kegiatan">Kegiatan</a>
                    </li>
